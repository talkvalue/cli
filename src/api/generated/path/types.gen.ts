...
export type PersonCompanyRes = {
    ...
    displayName: string;
    /**
     * person 수정 API에서 companyName 수정 가능 여부, id가 할당된 경우 Company쪽에서 수정할 수 있다
     */
...
export type ColumnMappingReq = {
    csvIndex: number;
    targetField: 'EMAIL' | 'FIRST_NAME' | 'LAST_NAME' | 'NAME' | 'PHONE' | 'JOB_TITLE' | 'COMPANY_NAME' | 'ADDRESS' | 'LINKEDIN_URL' | 'X_URL' | 'JOINED_AT';
};
...
export type AnalyzeRes = {
    ...
    missingRequired: Array<'EMAIL' | 'FIRST_NAME' | 'LAST_NAME' | 'NAME' | 'PHONE' | 'JOB_TITLE' | 'COMPANY_NAME' | 'ADDRESS' | 'LINKEDIN_URL' | 'X_URL' | 'JOINED_AT'>;
};

export type ColumnMappingRes = {
    csvIndex: number;
    csvHeader: string;
    suggestedField?: 'EMAIL' | 'FIRST_NAME' | 'LAST_NAME' | 'NAME' | 'PHONE' | 'JOB_TITLE' | 'COMPANY_NAME' | 'ADDRESS' | 'LINKEDIN_URL' | 'X_URL' | 'JOINED_AT';
    confidence?: number;
    suggestions: Array<SuggestionRes>;
};

export type SuggestionRes = {
    field: 'EMAIL' | 'FIRST_NAME' | 'LAST_NAME' | 'NAME' | 'PHONE' | 'JOB_TITLE' | 'COMPANY_NAME' | 'ADDRESS' | 'LINKEDIN_URL' | 'X_URL' | 'JOINED_AT';
    confidence: number;
};
...
export type UpdatePersonReq = {
    ...
    companyId?: number;
    /**
     * Company 할당 해제 여부, true이면 할당된 Company를 해제한다
     */
...
export type PersonChangeLogEntryRes = {
     ...
     * 변경 유형
     */
    action: 'CREATED' | 'UPDATED' | 'DELETED' | 'RESTORED' | 'MERGED' | 'UNMERGED' | 'SOURCE_CONNECTED' | 'SOURCE_DISCONNECTED';
    /**
     * 변경자 정보
     */
...
export type CreateIntegrationImportResponse = CreateIntegrationImportResponses[keyof CreateIntegrationImportResponses];
...
export type CreateEventPersonResponse = CreateEventPersonResponses[keyof CreateEventPersonResponses];
...
export type ListChannelPeopleResponse = ListChannelPeopleResponses[keyof ListChannelPeopleResponses];
...
export type CreateChannelPersonResponse = CreateChannelPersonResponses[keyof CreateChannelPersonResponses];
...
export type GetIntegrationImportJobResponse = GetIntegrationImportJobResponses[keyof GetIntegrationImportJobResponses];
...
export type GetIntegrationImportCandidatesResponse = GetIntegrationImportCandidatesResponses[keyof GetIntegrationImportCandidatesResponses];
...
export type ExportFailedRowsCsvResponse = ExportFailedRowsCsvResponses[keyof ExportFailedRowsCsvResponses];
...
export type ExportEventPeopleCsvResponse = ExportEventPeopleCsvResponses[keyof ExportEventPeopleCsvResponses];
...
export type ListCompanyPeopleResponse = ListCompanyPeopleResponses[keyof ListCompanyPeopleResponses];
...
export type ExportCompanyPeopleCsvResponse = ExportCompanyPeopleCsvResponses[keyof ExportCompanyPeopleCsvResponses];
...
export type ExportChannelPeopleCsvResponse = ExportChannelPeopleCsvResponses[keyof ExportChannelPeopleCsvResponses];
...
export type GetEventParticipantTrendResponse = GetEventParticipantTrendResponses[keyof GetEventParticipantTrendResponses];
...
export type GetChannelEventContributionResponse = GetChannelEventContributionResponses[keyof GetChannelEventContributionResponses];
...
export type GetChannelOverlapResponse = GetChannelOverlapResponses[keyof GetChannelOverlapResponses];
