...
export type DiversificationRes = {
	totalUniquePersons: number;
	channels: Array<ChannelMetricRes>;
	companies: Array<CompanyMetricRes>;
};

export type GrowthRes = {
...
export type PathOverviewRes = {
	...
	diversification: DiversificationRes;
	growth: GrowthRes;
...
export type AttachTagToSourceData = {
	body: AttachTagReq;
	path: {
		sourceId: number;
	};
...
export type AttachTagToSourceErrors = {
	400: unknown;
	404: unknown;
};

export type AttachTagToSourceResponses = {
	200: TagRes;
};

export type AttachTagToSourceResponse =
	AttachTagToSourceResponses[keyof AttachTagToSourceResponses];
...
export type GetEventParticipantTrendErrors = {
	404: unknown;
};
...
export type DetachTagFromSourceData = {
	body?: never;
	path: {
		tagId: number;
		sourceId: number;
...
export type DetachTagFromSourceErrors = {
	404: unknown;
};

export type DetachTagFromSourceResponses = {
	200: unknown;
};
